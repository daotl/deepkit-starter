// codegen:start {preset: custom, source: ../../../eslint-codegen/edgedb-helpers.ts, export: all}
...
import type { ModelMap } from '../utils'
import { type UpsertShape, upsertConflictGetter } from './common'
