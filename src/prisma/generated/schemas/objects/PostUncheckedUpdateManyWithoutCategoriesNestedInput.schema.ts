...
const Schema: z.ZodType<Prisma.PostUncheckedUpdateManyWithoutCategoriesNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => PostUpdateManyWithWhereWithoutCategoriesInputObjectSchema,
          ),
          z
            .lazy(
              () => PostUpdateManyWithWhereWithoutCategoriesInputObjectSchema,
...
export const PostUncheckedUpdateManyWithoutCategoriesNestedInputObjectSchema =
  Schema
