...
const Schema: z.ZodType<Prisma.PostUncheckedCreateNestedManyWithoutCategoriesInput> =
  z
    .object({
      create: z
        .union([
...
export const PostUncheckedCreateNestedManyWithoutCategoriesInputObjectSchema =
  Schema
