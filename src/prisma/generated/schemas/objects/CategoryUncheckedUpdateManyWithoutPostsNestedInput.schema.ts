...
const Schema: z.ZodType<Prisma.CategoryUncheckedUpdateManyWithoutPostsNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => CategoryUpdateManyWithWhereWithoutPostsInputObjectSchema,
          ),
          z
            .lazy(
              () => CategoryUpdateManyWithWhereWithoutPostsInputObjectSchema,
...
export const CategoryUncheckedUpdateManyWithoutPostsNestedInputObjectSchema =
  Schema
