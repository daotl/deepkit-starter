...
const Schema: z.ZodType<Prisma.PostUpdateManyWithWhereWithoutCategoriesInput> =
  z
    .object({
...
export const PostUpdateManyWithWhereWithoutCategoriesInputObjectSchema = Schema
